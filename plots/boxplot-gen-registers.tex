...
\begin{document}
\begin{tikzpicture}
	\pgfplotstableread[col sep=comma]{tacas2024-gen-registers-r10.csv}\csvdata
	\pgfplotstableread[col sep=comma]{tacas2024-gen-registers-r20.csv}\csvdatb
	\pgfplotstableread[col sep=comma]{tacas2024-gen-registers-r30.csv}\csvdatc
	\pgfplotstableread[col sep=comma]{tacas2024-gen-registers-r40.csv}\csvdatd
	\pgfplotstableread[col sep=comma]{tacas2024-gen-registers-r50.csv}\csvdate
	\begin{axis}[
